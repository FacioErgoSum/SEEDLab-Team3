...
matrixFileLoad = "transformation_matrix3.yaml"
...
#!!!! !!!! !!!! !!!!
#All setup code here for I2C here, loop code is at the bottom
runI2C = True
...
for frame in camera.capture_continuous(rawCapture, format="rgb", use_video_port=True):
    ...
    if len(corners) > 0:
        ...
        if (markerID in ids) :
            ...
            #Print found marker info to console
            #print("Marker with ID:" + str(markerID) + " was found at World Coordanites X:" + str(targetPointX) + ", Y:" + str(targetPointY))
            #print("Marker with ID:" + str(markerID) + " was found at Relative Coordanites X:" + str(fix[0]) + ", Y:" + str(fix[1]))
            #print("I am at X: %7.2f  Y: %7.2f  Phi: %7.2f , Marker at X: %7.2f  Y:%7.2f " % (robot_X, robot_Y, robotAngle, targetPointX, targetPointY))
            

            #print on screen
            #writeData = "X:" +  str(fix[0]) + ", Y:" + str(fix[1])
            #cv2.putText(gray, writeData, (cX+8,cY+20), font, 1, (255,255,255),1,cv2.LINE_AA)
    ...
    # # ------------------ Geoff's Makeshift Minimap --------------------- #
        ...
        # screenSizeMiddle = 11
        # inchesPerPixel = 6
        # screenSizeInches = screenSizeXY*inchesPerPixel
        
        # originX = round(0.17*robot_X + screenSizeMiddle)
        # originY = round(0.17*robot_Y + screenSizeMiddle)
        # targetX = round(0.17*targetPointX + screenSizeMiddle)
        # targetY = round(0.17*targetPointY + screenSizeMiddle)
        # for x in range(screenSizeXY):
            # for y in range(screenSizeXY):
                # if(x == originX and y == originY):
                    # print("R",end="")
                # elif(x == targetX and y == targetY):
                    # print("X",end="")
                # elif(x == screenSizeMiddle and y == screenSizeMiddle):
                    # print("O",end="")
                # else:
                    # print("`",end="")
            # print("")
